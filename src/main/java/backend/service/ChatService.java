...
import backend.rest.model.chat.ChatDto;
import backend.rest.model.chat.MessageDto;
import backend.repository.ChatRepository;
import backend.repository.MessageRepository;
import backend.repository.UserRepository;
import backend.rest.model.common.UserDto;
...
import static backend.model.Chat.*;
