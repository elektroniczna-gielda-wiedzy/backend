...
VALUES
                                                                                                                          ('Adam', 'Kowalski', 'adamkowalski@student.agh.edu.pl', '$2a$10$mraQzwvvxI0GK.u.IvAwV.esajUJb5d2l.qpfNWIAx.kwu6Yy44QK', true, current_timestamp, current_timestamp, false, false),
                                                                                                                          ('Maria', 'Kowalska', 'mariakowalska@student.agh.edu.pl', '$2a$10$mraQzwvvxI0GK.u.IvAwV.esajUJb5d2l.qpfNWIAx.kwu6Yy44QK', true, current_timestamp, current_timestamp, false, false),
                                                                                                                          ('Marek', 'Król', 'marekkrol@student.agh.edu.pl', '$2a$10$mraQzwvvxI0GK.u.IvAwV.esajUJb5d2l.qpfNWIAx.kwu6Yy44QK', true, current_timestamp, current_timestamp, false, false),
                                                                                                                          ('Patryk', 'Kowal', 'patrykkowal@student.agh.edu.pl', '$2a$10$mraQzwvvxI0GK.u.IvAwV.esajUJb5d2l.qpfNWIAx.kwu6Yy44QK', true, current_timestamp, current_timestamp, false, false),
                                                                                                                          ('Michał', 'Markowski', 'michalmarkowski@student.agh.edu.pl', '$2a$10$mraQzwvvxI0GK.u.IvAwV.esajUJb5d2l.qpfNWIAx.kwu6Yy44QK', true, current_timestamp, current_timestamp, false, false),
                                                                                                                          ('Adrian', 'Król', 'adriankrol@student.agh.edu.pl', '$2a$10$mraQzwvvxI0GK.u.IvAwV.esajUJb5d2l.qpfNWIAx.kwu6Yy44QK', true, current_timestamp, current_timestamp, false, false),
                                                                                                                          ('Patryk', 'Markowski', 'patrykmarkowski@student.agh.edu.pl', '$2a$10$mraQzwvvxI0GK.u.IvAwV.esajUJb5d2l.qpfNWIAx.kwu6Yy44QK', true, current_timestamp, current_timestamp, false, false),
                                                                                                                          ('Admin', 'Adminowski', 'admin@student.agh.edu.pl', '$2a$10$mraQzwvvxI0GK.u.IvAwV.esajUJb5d2l.qpfNWIAx.kwu6Yy44QK', true, current_timestamp, current_timestamp, true, false),
                                                                                                                          ('Maciej', 'Kowalski', 'mkowalski@student.agh.edu.pl', '$2a$10$mraQzwvvxI0GK.u.IvAwV.esajUJb5d2l.qpfNWIAx.kwu6Yy44QK', true, current_timestamp, current_timestamp, true, true);
...
INSERT INTO entry(entry_id, user_id, entry_type_id, title, content, created_at, updated_at, is_deleted) VALUES
                                                                                                            (1, 4, 0,
                                                                                                             'Zrozumienie zasad termodynamiki', 'Notatka ta ma na celu zrozumienie podstawowych zasad termodynamiki, kluczowej dziedziny fizyki, która jest niezbędna dla zrozumienia szeregu zjawisk naturalnych i technologicznych. W notatce zawarte są szczegółowe wyjaśnienia, rysunki oraz przykładowe zadania.
...
Chętnych do nauki proszę o nawiązanie kontaktu poprzez system czatowy w aplikacji.',
                                                                                                             current_timestamp, current_timestamp, false),
                                                                                                            (3, 4, 2,
                                                                                                             'Problem z nieskończoną pętlą w algorytmie Bubble Sort', 'Cześć wszystkim, mam problem z implementacją algorytmu sortowania bąbelkowego w Pythonie. Poniżej znajduje się kod, który napisałem, ale niestety program wpada w nieskończoną pętlę. Czy mógłby mi ktoś pomóc?',
                                                                                                             current_timestamp, current_timestamp, false),
                                                                                                            (4, 1, 0,
                                                                                                             'Najlepsze praktyki z zakresu cyberbezpieczeństwa', 'Ta notatka omówi niektóre z najważniejszych zasad cyberbezpieczeństwa, które mogą być użyte do ochrony Twoich informacji. Dowiesz się jak stosować najlepsze praktyki z zakresu haseł, bezpiecznych nawyków przeglądania, dwuskładnikowego uwierzytelniania, i więcej. Zajrzyj pod poniższy link' ||
                                                                                                                                                                          '
                                                                                                            ...
                                                                                                            (5, 1, 2,
                                                                                                             'Badanie wpływu kultury w erze cyfrowej', 'Piszę pracę o wpływie internetu i technologi cyfrowej na kulturę. Czy moglibyście podzielić się swoimi odczuciami i przemyśleniami odnoścnie tego czy zaważanie wpływ internetu na to w jaki sposób komunikujecie się i odnosicie do innych ludzi?', current_timestamp - INTERVAL '90 minutes', current_timestamp, false),
                                                                                                            (6, 1, 0,
                                                                                                             'Piękno matematyki dyskretnej notatka z obrazem', 'Głębokie zanurzenie w piękny świat matematyki dyskretnej. W tej notatce wyjaśniam, jak matematyka dyskretna pomaga w rozwiązywaniu skomplikowanych problemów informatyki.', current_timestamp - INTERVAL '20 minutes', current_timestamp, false),
                                                                                                            (7, 2, 1,
                                                                                                             'Pomoc w zadaniach domowych z algebry', 'Jeśli ktokolwiek ma problemy z zadaniem domowym z algebry, śmiało pisz. Mogę pomóc w tematach obejmujących równania liniowe, nierówności, wykresy, macierze, wielomiany i wyrażenia pierwiastkowe, równania i funkcje kwadratowe, wyrażenia wykładnicze i logarytmiczne, sekwencje i serie, prawdopodobieństwo i więcej.', current_timestamp - INTERVAL '30 minutes', current_timestamp, false),
                                                                                                            (8, 3, 0,
                                                                                                             'Zrozumienie pochodnych w analizie matematycznej', 'W tej notatce wyjaśniłem pojęcie pochodnych w analizie matematycznej. Notatka zaczyna się od podstawowej definicji, po której następują reguły różniczkowania i zastosowania. Znajdują się tam przykłady i problemy do samodzielnego rozwiązania.' ||
                                                                                                                                                                          '
                                                                                                            ...
                                                                                                            (9, 3, 1,
                                                                                                             'Poszukiwanie grupy studenckiej do nauki termodynamiki', 'Cześć wszystkim, staram się zorganizować grupę studiującą do nadchodzącego egzaminu z termodynamiki. Jeśli jesteś zainteresowany, proszę napisz do mnie wiadomość. Planujemy spotykać się dwa razy w tygodniu, aby omówić koncepcje, rozwiązać problemy i pomóc sobie nawzajem zrozumieć materiał.', current_timestamp - INTERVAL '70 minutes', current_timestamp, false),
                                                                                                            (10, 3,
                                                                                                             2, 'Problem z programowaniem obiektowym', 'Mam problem ze zrozumieniem koncepcji dziedziczenia i polimorfizmu w programowaniu obiektowym. Czy ktoś mógłby to wyjaśnić za pomocą przykładu? Używam C++ na moim kursie.', current_timestamp - INTERVAL '80 minutes', current_timestamp, false),
                                                                                                            (11, 3,
                                                                                                             1, 'Szukam partnera do nauki struktur danych', 'Szukam partnera do nauki na nadchodzący kurs struktur danych. Moim celem jest wspólne studiowanie i zdobycie 5.0 na tym kursie. Jeśli jesteś zainteresowany, odpisz na ten post.', current_timestamp - INTERVAL '90 minutes', current_timestamp, false),

                                                                                                            (12, 4,
                                                                                                             0, 'Wprowadzenie do fizyki kwantowej', 'Ta notatka obejmuje podstawy fizyki kwantowej, ważnego obszaru fizyki, który stanowi podstawę wielu nowoczesnych technologii. Zawiera szczegółowe wyjaśnienia, diagramy i przykładowe problemy. Znajdź notatkę tutaj: https://drive.google.com/file/d/1NPnrH_UrqTQdgfdFOIJ05DGDEC5sdfYPsNU/view?usp=sharing', current_timestamp - INTERVAL '160 hours', current_timestamp, false),
                                                                                                            (13, 4,
                                                                                                             2, 'Problem z pętlą w Pythonie', 'Cześć wszystkim, mam problem z programem w Pythonie. Wydaje się, że wpada on w nieskończoną pętlę. Czy ktoś może pomóc?', current_timestamp - INTERVAL '90 minutes', current_timestamp, false),
                                                                                                            (14, 5,
                                                                                                             0, 'Schemat bazy danych z ćwiczeń podczas eRajdu', 'Jako, że spora część osób była w piątek na eRajdzie dr Kowalski prosił, aby podzielić się z nieobecnymi schematem bazy nad którym pracowaliśmy. Jeśli coś jest niejasne możesz śmiało do mnie pisać, postaram się to wytłumaczyć najlepiej jak mogę', current_timestamp - INTERVAL '6 minutes', current_timestamp, false),
                                                                                                            (15, 5,
                                                                                                             2, 'Problem z rozwiązaniem zadania z programowania', 'Cześć wszystkim, mam problem z jednym z zadań z programowania. Chodzi o implementację algorytmu sortowania w języku Python. Czy ktoś mógłby mi pomóc zrozumieć, jak to zrobić?', current_timestamp - INTERVAL '300 minutes', current_timestamp, false),
                                                                                                            ...
                                                                                                            (17, 6,
                                                                                                             1, 'Szukam grupy do nauki termodynamiki', 'Cześć, próbuję zorganizować grupę do nauki na nadchodzący egzamin z termodynamiki. Jeśli jesteś zainteresowany, wyślij mi wiadomość. Planujemy spotykać się dwa razy w tygodniu i pracować nad arkuszami egzaminacyjnymi i trudnymi pytania.', current_timestamp - INTERVAL '50 days', current_timestamp, false),
                                                                                                            (18, 7,
                                                                                                             1, 'Pytanie o prowadzących kurs analizy matematycznej', 'Cześć, czy ktoś z was może mi powiedzieć, jakie są godziny konsultacji u prowadzących kurs analizy matematycznej? Z góry dzięki za pomoc!', current_timestamp - INTERVAL '12 minutes', current_timestamp, false);
